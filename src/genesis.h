...
public:
    ...
    int getScreenHeight() const {
        int h = vdp.activeHeight;  // 224 or 240
        // Only interlace mode 3 (double resolution) doubles the framebuffer.
        // Mode 1 (standard interlace) renders the current field at native res.
    ...
    static constexpr int Z80_CYCLES_PER_SCANLINE = 228;  // Approximate
...
private:
    ...
    int z80CycleDebt;           // carry-over from scanline overshoot (negative = overshoot)
