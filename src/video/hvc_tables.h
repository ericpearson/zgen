// Hardware-accurate H counter tables: maps each of the 3420 master clocks
// per scanline to the corresponding 8-bit H counter value.
// Derived from oscilloscope measurements of the VDP's internal counters.
// Source: Genesis-Plus-GX hvc.h (public domain hardware truth tables).
//
// H40 (320px): 210 unique H counter values, each spanning ~16 master clocks.
//   Pattern: 0xA5..0xB6 (active start), jump to 0xE4, then 0xE4..0xFF, 0x00..0xA4.
//
// H32 (256px): 171 unique H counter values, each spanning ~20 master clocks.
//   Pattern: 0x85..0x93, jump to 0xE9, then 0xE9..0xFF, 0x00..0x84.

#pragma once

#include <cstdint>

static constexpr uint8_t cycle2hc32[3420] =
{
...
static constexpr uint8_t cycle2hc40[3420] =
{
