...
`src/video/vdp.*`, `src/video/vdp_slot_table.h`, `src/video/vdp_dma.cpp`, `src/video/vdp_render.cpp`, and `src/video/vdp_renderer_timed.cpp` implement the current VDP.
...
The segment-render rule lives across `src/video/vdp.cpp`, `src/video/vdp_dma.cpp`, `src/video/vdp_render.cpp`, and `src/video/vdp_renderer_timed.cpp`.
